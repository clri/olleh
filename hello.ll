...
@1 = private unnamed_addr constant [14 x i8] c"!dlrow ,olleh\00"
...
entry:
  ...
  %printf1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @1, i32 0, i32 0))
